...
Examples:
  ...
  python src/cli.py --audio audio.wav --output video.mp4 --verbose
    ...
    parser.add_argument('--profile', help='Character profile (e.g., character_2_emotional)')
    parser.add_argument('--cinematic-mode', choices=['emotional', 'tension', 'balanced'], 
                       default='balanced', help='Cinematographic approach to use')
    ...
    try:
        ...
        logger.info(f"Generating content with cinematic mode '{args.cinematic_mode}'...")
