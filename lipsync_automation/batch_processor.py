...
def process_single_file(audio_path: Path, output_dir: Path, preset_name: str,
                       ...
                       preset_config: dict, cache_manager: Optional[CacheManager] = None) -> Tuple[str, bool, str]:
        ...
        compositor.render_multiscene_video(
            shot_sequence=[{
                ...
                'shot_specification': {
                    'distance': 'MCU',
                    'angle': 'eye_level', 
                    'duration': phoneme_data['duration'] if 'duration' in phoneme_data else 2.0  # Use actual duration if available
                },
...
class MockCompositor:
    ...
    def render_video(self, frame_sequence, audio_path, output_path, background_path=None, mouth_position=None):
