...
class OverrideManager:
    ...
    def _load_override_rules(self) -> Dict[str, Any]:
        ...
        try:
            ...
            override_rules: Dict[str, Any] = rules.get('override_rules', {
    ...
    def _override_applies(self, override: Dict, shot: Dict, 
                         shot_index: int, emotion_analysis: Optional[Dict] = None) -> bool:
        """
...
class CinematographicOverrideHelper:
    ...
    @staticmethod
    def create_closeup_override(override_id: str, segment_id: Optional[str] = None, 
