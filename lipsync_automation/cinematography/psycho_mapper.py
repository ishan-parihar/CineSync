...
class PsychoCinematicMapper:
    ...
    def _load_emotion_mappings(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return cast(Dict[str, Any], rules.get('emotion_mappings', {
    ...
    def select_shot(self, emotion_data: Dict, context: Optional[Dict] = None) -> Dict[str, Any]:
        """
    ...
    def _determine_distance(self, emotion_data: Dict, context: Dict) -> str:
        ...
        emotion_prefs = cast(Dict[str, Any], self.emotion_shot_mappings.get(emotion_name, self.emotion_shot_mappings['trust']))
    ...
    def _determine_duration(self, emotion_data: Dict, context: Dict) -> float:
        ...
        distance = cast(str, previous_shot.get('distance', 'MS')) if previous_shot else 'MS'
