...
def simulate_websocket_events():
    ...
    events = [
        ...
        # Tension analysis
        {
            ...
            "dramatic_moments": [
                {"segment_index": 2, "tension_level": 0.78, "tension_type": "high"}
            ],
        },
    ...
    for i, event in enumerate(events):
        ...
        if event["type"] == "connection_established":
            ...
            print(
                f"   ✨ Capabilities: {', '.join([k for k, v in event['server_capabilities'].items() if v])}"
            )
            ...
            print(
                f"   🎨 Valence: {segment['valence']:.2f}, Arousal: {segment['arousal']:.2f}"
            )
            ...
            print(
                f"   📈 Tension: {event['tension_level']} ({event['tension_score']:.2f})"
            )
            ...
            print(
                f"   📊 Summary: {summary['total_emotion_segments']} segments, {summary['total_shot_decisions']} shots"
            )
