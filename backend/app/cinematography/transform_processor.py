...
class TransformProcessor:
    ...
    def apply_vertical_angle(
        self, image: Image.Image, angle: str, frame_size: Tuple[int, int]
    ) -> Image.Image:
        """
        ...
        logger.debug(
            f"Applied {angle} transform: y_offset={y_offset_percent}, rotation={rotation_degrees}"
        )

        return image

    def calculate_composition_position(
        self,
        composition: str,
        framing: str,
